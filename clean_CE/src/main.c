...
int main(){
    ...
    actuator = global_actuator; // Use the calculated coefficients
        ...
        // store local variables in shared arrays to allow accumalation between cores
        yhy_11_shared[core_id] = yhy_11; 
        yhy_12_shared[core_id] = yhy_12; 
        yhy_13_shared[core_id] = yhy_13; 
        yhy_23_shared[core_id] = yhy_23; 
        yhy_33_shared[core_id] = yhy_33;
        
        yhe_1_r_shared[core_id] = yhe_1_r;  
        yhe_1_i_shared[core_id] = yhe_1_i; 
        yhe_2_r_shared[core_id] = yhe_2_r; 
        yhe_2_i_shared[core_id] = yhe_2_i; 
        yhe_3_r_shared[core_id] = yhe_3_r; 
        yhe_3_i_shared[core_id] = yhe_3_i; 
