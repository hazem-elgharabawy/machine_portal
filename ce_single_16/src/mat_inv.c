...
int8_t mat_inv(const Matrix_S* mat, Matrix_S* inv) {
    ...
    printf("det0 = %lf\n", fixed_to_double(det0));
    printf("det1 = %lf\n", fixed_to_double(det1));
    printf("det2 = %lf\n", fixed_to_double(det2));
    printf("det3 = %lf\n", fixed_to_double(det3));
    ...
    inv->a11 = fixed_div(adj.a11, det) >> 6;
    inv->a12 = fixed_div(adj.a12, det) >> 6;    
    inv->a22 = fixed_div(adj.a22, det) >> 6;
    inv->a13 = fixed_div(adj.a13, det) >> 6;    
    inv->a23 = fixed_div(adj.a23, det) >> 6;
    inv->a33 = fixed_div(adj.a33, det) >> 6; 
