...
int main(){
    ...
    actuator.a10_r = double_to_fixed(1);
    ...
    for (int i = 0; i < SET_SIZE; i ++ ) {
        ...
        fixed_point_t y_r_temp = sync_pa_out_r_arr[i];
        fixed_point_t y_i_temp = sync_pa_out_i_arr[i];
        
        fixed_point_t yp_r_temp = post_dist_out_r_arr[i];
        fixed_point_t yp_i_temp = post_dist_out_i_arr[i];
        
        fixed_point_t xp_r_temp = sync_pa_in_r_arr[i];
        fixed_point_t xp_i_temp = sync_pa_in_i_arr[i];
    ...
    {
        yhy_11 += yhy_11_acumalator_arr[i];
    }
...
*/
    ...
    yhy_matrix.a11 = (yhy_11 >> 2);
    yhy_matrix.a12 = (yhy_12 >> 2);
    yhy_matrix.a13 = (yhy_13 >> 2);
    yhy_matrix.a23 = (yhy_23 >> 2);
    yhy_matrix.a33 = (yhy_33 >> 2);
